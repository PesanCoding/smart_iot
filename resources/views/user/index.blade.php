...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="javascript:void(0)" id="btn-create-user" class="btn btn-sm btn-primary mb-3">Tambah User</a>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $item )
                            ...
                            <tr>
                                <td>{{$no}}</td>
                                <td>
                                    <img src="{{url('storage',$item->profile_photo_path)}}" alt="" class="brand-image img-circle" style="width: 80px" height="80px">
                                </td>
                                <td>
                                ...
                                <td>
                                    <form method="post" action="{{url('user',$item->id)}}" id="delete{{$item->id}}">
                                        ...
                                        <a href="javascript:void(0)" id="btn-edit-post" data-id="{{ $item->id }}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                    </form>
