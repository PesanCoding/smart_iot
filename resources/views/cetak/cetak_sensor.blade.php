...
<body>
    <footer>
            Copyright © <?php echo date("Y");?> - Smart Garden Monitoring & Control
    </footer>
	<div id="page-wrap">
		<table width="100%">
			<tbody>
		...
		<table width="100%" class="outline-table">
			<tbody>
				...
				<tr class="border-bottom border-right center">
					...
					<td width="25%"><strong>DHT 11 Sensor</strong></td>
					<td width="30%"><strong>Soil  Sensor</strong></td>
				</tr>
				<tr class="border-right">
					<td class="pad-left">Cetak Data : {{$tanggal}}</td>
					<td class="center">Rata-rata ({{$rata_kel_udara}})</td>
					<td class="right-center">Rata-rata {{$rata_kel_tanah}}</td>
				</tr>
		...
		<table width="100%" class="outline-table">
			<tbody>
				...
				<tr class="border-bottom border-right center">
					...
					<td width="25%"><strong>Suhu Udara</strong></td>
					<td width="30%"><strong>Kelembaban Tanah</strong></td>
				</tr>
                @foreach ($data as $item )
				<tr class="border-bottom border-right">
					<td class="pad-left">{{$item->waktu}}</td>
					<td class="center">{{$item->kel_udara}} C<sup>o</sup></td>
					<td class="right-center">{{$item->kel_tanah}}<sup>%</sup></td>
				</tr>
                @endforeach
